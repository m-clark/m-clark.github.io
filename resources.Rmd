...
- [Scikit-learn](http://scikit-learn.org/stable/)  Efficient tools for data mining and data analysis
- [Pandas](http://pandas.pydata.org/) Dealing with data in an R-like way, sort of
...
- [Probabilistic Machine Learning](https://probml.github.io/pml-book/book1.html) by Murphy
