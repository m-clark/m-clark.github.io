...
save(bam_big, file = 'posts/2019-10-20-big-mixed-models/bam_big.RData') # evidently not saved the first time?
```
...
save(bam_big_d, file = 'posts/2019-10-20-big-mixed-models/bam_big_d.RData') 
```
