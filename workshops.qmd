...
I used to give workshops regularly when I worked in academia, and I have kept the content here. Some were not so much workshops as talks without any expectation of hands-on exercises or similar, so may not be as useful without the in-person context. Some of these, especially programming specific ones, are likely too dated to be useful anymore. The modeling focused ones may still have relevant content however.
