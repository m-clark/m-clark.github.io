...
I spend the bulk of my other efforts in coding with <span itemscope itemtype ="https://schema.org/ComputerLanguage">Python</span>, where I've used it for general machine learning, some natural language processing, and other endeavors. I also have to consistently dive into other programming as necessary, such as for web development and report generation. I like programming in general and solving problems with it, and I'm lucky enough to spend regular time simply learning new modeling and programming tricks.
