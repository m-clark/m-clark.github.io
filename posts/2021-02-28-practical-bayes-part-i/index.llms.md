...
![](index_files/figure-html/model-start-trace-dens-1.png)
...
![](index_files/figure-html/rnorm-trace-dens-1.png)

``` r
ggplot2::qplot(x = rnorm(1000), geom = 'density')
```

![](index_files/figure-html/rnorm-trace-dens-2.png)
...
![](index_files/figure-html/area-violin-1.png)

``` r
mcmc_plot(model_start_100, pars = c('b1', 'b2', 'x1'), type = 'violin')
```

![](index_files/figure-html/area-violin-2.png)
...
![](index_files/figure-html/trace-highlight-1.png)
...
![](index_files/figure-html/rank-plots-1.png)

``` r
mcmc_plot(model_start_100, pars = c('b1', 'b2', 'x1'), type = 'rank_overlay')
```

![](index_files/figure-html/rank-plots-2.png)
...
![](index_files/figure-html/rhat-plot-1.png)
...
![](index_files/figure-html/neff-plot-1.png)
...
![](index_files/figure-html/trace-plot-1.png)
...
![](index_files/figure-html/dens-plot-1.png)
...
![](index_files/figure-html/rank-plot-1.png)
...
![](index_files/figure-html/acf-plot-1.png)

### Efficiency plots

I have seen these often recommended, but I’m not aware of a package does them, though it seems they may make their way to shinystan at some point. Aki Vehtari has supplied a walk-through and some code (see the [resources section](Resources) below), but there isn’t really documentation for the functions, and they likely won’t work outside of rstan objects, or at least I had limited success with applying them to brms objects. Furthermore, these are getting into waters that are beyond what I’d expect applied users to be wading through.
...
![](index_files/figure-html/model-start-checks-show-1.png)
...
![](index_files/figure-html/pairs-plot-model-start-complex-1.png)
...
![](index_files/figure-html/pairs-plot-model-start-1.png)
...
![](index_files/figure-html/par-coord-1.png)
...
![](../../img/howtobayes/max_treedepth.png)
...
Clark, Michael. 2021. “Practical Bayes Part I.” February 28. <https://m-clark.github.io/posts/2021-02-28-practical-bayes-part-i/>.

[^1]: I will spare the details of my opinions, which are almost entirely negative.

[^2]: For this model, they are uniform/improper priors for the regression coefficients and half-t for the residual variance. You can always use prior_summary on a brms model to see this.
