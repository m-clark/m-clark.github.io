...
<span itemscope itemtype ="http://schema.org/WebApplication">
[<span itemprop="name">gammit</span>](https://github.com/m-clark/gammit/)     
<span itemprop="description">
The package provides a set of functions to aid using `mgcv` (possibly solely) for mixed models.
</span>
</span>
