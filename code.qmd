...
A lot of the following are things I do for fun or personal interest and development. Here you will find a summary of stuff that I've done in the past, but for my latest efforts, check me out on [GitHub](https://github.com/m-clark). Almost all of my work nowadays is for clients and internal use that is not publicly available.
