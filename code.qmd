...
# part of multi-head attention code to create an image of at carbon.now.sh
...
![](img/code_logo.svg){width=200px}

A lot of the following are things I have done in the past for fun or personal interest and development. For my latest efforts, check me out on [GitHub](https://github.com/m-clark), but note that almost all of my work nowadays is for clients and internal use that is not publicly available.
