...
<aside>The <span class="pack" style = "">gammit</span> package is available on [GitHub](https://m-clark/github.com/gammit).</aside>
...
kable_df(lmer_vcov %>% select(-var2), caption = 'LME Result')
