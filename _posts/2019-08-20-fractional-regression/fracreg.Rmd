...
Perhaps not surprisingly, all of the covariates are statistically notable.  With the logistic link, the coefficients can be exponentiated to provide odds ratios[^orstata].  This is one of the few tools that is readily available to model such outcomes, but as we're about to see, you definitely don't need Stata once you know what's going on.
