...
Fractional data occurs from time to time.  While Stata has a specific function for such outcomes, and has done a lot to promote a means to handle them, practically any statistical tool could do so.  In the demo above, a standard glm with robust errors would be fine, and the simplest to pull off, but you have other tools and approaches available as well.
