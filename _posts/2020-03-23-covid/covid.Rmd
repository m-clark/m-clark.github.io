...
init +
  ...
  guides(color = 'none') # labels = as_date(unique(init$data$date_num))
```
...
initial_values = function() {
  list(
    theta = c(runif(1, 0, 5), runif(1, 0.2, 0.4)),
...
We can do a posterior predictive check of our expected vs. observed counts.  Not perfect, and definitely could be better, but not too bad I suppose.
