...
Chatzilenaa, van Leeuwen,Ratmann, Baguelin, & Demiris (2019)
...
initial_values = function() {
  list(
    theta = c(runif(1, .5, 5), runif(1, 0.2, 0.4)),
...
samples_infected %>% 
  ...
  geom_point(aes(y = infected), data = washtenaw) +
