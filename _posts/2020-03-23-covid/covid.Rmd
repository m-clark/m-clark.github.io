...
mi_counties_sf$area <- as.numeric(st_area(mi_counties_sf))
...
prep_counties = county_trends %>% 
  ...
  filter(!state %in% c('alaska', 'hawaii', 'puerto rico'), long < 100)
...
all_counties_sf2$area = as.numeric(st_area(all_counties_sf2))

glimpse(all_counties_sf2)
