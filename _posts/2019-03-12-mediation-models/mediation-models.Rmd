...
```{r gm_mediation, echo=FALSE, cache=FALSE}
...
```{r bnlearn_reproduction, eval=FALSE}
whitelist = data.frame(
...
```{r package_comparison_table, echo=FALSE}
tibble(
  Automatic = c('✔','', '✔*'),
