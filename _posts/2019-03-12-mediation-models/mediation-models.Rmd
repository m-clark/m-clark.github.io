...
```{r brms, cache=TRUE, echo=-15, cache.rebuild=F}
library(brms)
...
```{r bnlearn_reproduction, eval=T, fig.height=5, cache.rebuild=T}
whitelist = data.frame(
...
```{r pythonbs, echo = FALSE, eval=!file.exists("C:/Program Files/R/")}
reticulate::use_python("/Users/micl/anaconda3/bin")
```
