...
I had this info on my whiteboard for a long time thinking I'd get back to it at some point, but never really did.  I had started this [one project](https://github.com/m-clark/connections), but abandoned when the package it relied on made fundamental, breaking changes without documentation. There I had 
...
- AR(1) = GP with matern covariance and nu fixed to some 1/2 (i.e. $\nu+1/2 = p$)
...
- GP $\leadsto$ Thinplate, Duchon spline for a GAM
