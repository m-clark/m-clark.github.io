...
load('data/dl_for_tabular_summary_tables.RData')
```
...
- 9 of 12 data sets had only numeric features, two had a single categorical feature, and unfortunately, only one of these might be called truly *heterogeneous*, i.e., with a notable mix of categorical and numeric features[^heteroboost].  
