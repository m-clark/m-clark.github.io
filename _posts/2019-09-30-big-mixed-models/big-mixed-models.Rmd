...
In general you'll need very large data for this to be preferable. If a standard linear mixed model, you probably won't need it unless:
- You have complicated structure that begins to bog down lme4
- You want to add smooth terms[^smoothlme4]
- You have memory issues
    
For the generalized setting with binary, count, and other outcomes up to 100k observations:
- lme4 will almost certainly start giving convergence warnings
