...
In general you'll need very large data for this to be preferable. If doing a standard linear mixed model, you probably won't need bam unless:
...
- lme4, at least at the time of this writing, will almost certainly start giving convergence warnings
- glmmTMB is probably viable up to 100 k and one or two random effects
