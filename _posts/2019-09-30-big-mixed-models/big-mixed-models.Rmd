...
#### Linear mixed model
The following are for the linear mixed model.  `N` is the sample size, balanced refers to whether a random 75% sample was taken with proportion equivalent to the group index (first grouping variable for both 1 and 2 random effect settings), and `tau_2` is zero if there is only one random effect, or refers to the standard deviation of the second random effect. 
...
#### Generalized lienar mixed model
