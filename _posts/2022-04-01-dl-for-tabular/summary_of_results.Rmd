...
Used only classification accuracy results (as opposed to roc or loglik) for consistency with other papers. Key table is table 1 for summary, table 8 for accuracy details, 9 for numeric target details.
